...
public class InicioTest2 {
    ...
    public void inicioTest2() {
        ViewInteraction textView = onView(
                allOf(withId(R.id.btn_registrarMenu), withText("Registrar"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Registrar")));
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.btnRegistrar), withText("Registrar"),
                        childAtPosition(
                                allOf(withId(R.id.activity_registrar),
                                        childAtPosition(
                                                withId(android.R.id.content),
                                                0)),
                                7),
                        isDisplayed()));
        textView2.check(matches(withText("Registrar")));
