...
public class DBHandler extends SQLiteOpenHelper {
    ...
    private String pregunta = "CREATE TABLE Pregunta " +
            "(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,audio TEXT,texto TEXT,nombre_imagen TEXT,estado BOOLEAN,id_subcategoria INTEGER NOT NULL," +
    ...
    private String imagen_respuesta = "CREATE TABLE Imagen_Respuesta (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,nombre_imagen TEXT ,estado BOOLEAN,audio TEXT)";
    //Sql de la creación de la tabla intermedia entre imagen de respuesta y la tabla de pregunta
    private String imagen_respuesta_pregunta = "CREATE TABLE Imagen_Respuesta_Pregunta" +
            " (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,id_pregunta INTEGER ,id_imagen_pregunta INTEGER," + " FOREIGN KEY (id_pregunta) REFERENCES Persona (id) " +
            " FOREIGN KEY (id_imagen_pregunta) REFERENCES Imagen_Respuesta (id)" + ")";
    //Sql creación de la tabla respuesta
    private String respuesta = "CREATE TABLE Respuesta (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, audio TEXT, nombre_imagen TEXT , id_pregunta INTEGER NOT NULL, " + " FOREIGN KEY (id_pregunta) REFERENCES Pregunta (id)" + ");";
